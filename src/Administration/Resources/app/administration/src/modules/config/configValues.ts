// Pure helpers for translating between the config form (text) and the JSON values
...
// Human-readable rendering of a raw JSON text value for the read-only reference:
// a JSON string shows its inner text; anything else shows the raw JSON. Absent or
