...
export declare function resolveAdminApi(): CalloraAdminApi | undefined;
/**
 ...
 */
export declare function registerExtension(slot: AdminSlot, component: Component, order?: number): void;
/**
 ...
 */
export declare function registerHook<T>(name: AdminHook, handler: HookHandler<T>, order?: number): void;
/**
 ...
 */
export declare function registerService<T>(key: string, implementation: T, meta?: ServiceMeta): void;
/**
 ...
 */
export declare function registerPage(pluginId: string, component: Component, order?: number): void;
