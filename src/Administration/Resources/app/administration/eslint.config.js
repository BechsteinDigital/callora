...
export default tseslint.config(
  ...
  },
  {
    ...
    files: ['scripts/**/*.{js,mjs}', 'bin/**/*.mjs', '*.config.{js,ts}'],
  ...
  },
  {
    ...
    rules: {
      ...
      // Ein Stub in einem Test heißt "Stub" und nicht "TheTestStubComponent" — und zwei
      // Testkomponenten heißen "A" und "B", weil der Test von ihrer Reihenfolge handelt und
      // nicht von ihrem Namen.
