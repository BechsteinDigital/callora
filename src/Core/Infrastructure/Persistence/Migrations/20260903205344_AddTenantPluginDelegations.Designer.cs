...
namespace Callora.Core.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903205344_AddTenantPluginDelegations")]
    partial class AddTenantPluginDelegations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Callora.Core.Domain.Plugins.PluginInstallation", b =>
                {
                    ...
                    b.Property<string>("StoredAssemblyPath")
                        .IsRequired()
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
                        .HasColumnName("AssemblyPath");
            ...
            modelBuilder.Entity("Callora.Core.Domain.Plugins.TenantPluginDelegation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("WorkspacesMayAssign")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("tenant_plugin_delegations", (string)null);
                });
            ...
            modelBuilder.Entity("Callora.Core.Domain.Security.BackendRbacRole", b =>
                {
                    ...
                    b.Property<string>("ProvisionedAs")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("ProvisionedByPluginId")
                        .HasMaxLength(128)
                    ...
                    b.HasIndex("ProvisionedByPluginId", "ProvisionedAs")
                        .IsUnique()
            ...
            modelBuilder.Entity("Callora.Core.Domain.Snippets.SnippetBaseEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PluginId", "SnippetKey", "Locale")
                        .IsUnique();

                    b.ToTable("snippet_base", (string)null);
                });

            modelBuilder.Entity("Callora.Core.Domain.Snippets.SnippetOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SnippetKey", "Locale", "Scope", "ScopeKey")
                        .IsUnique();

                    b.ToTable("snippet_overrides", (string)null);
                });

            modelBuilder.Entity("Callora.Core.Domain.Surfaces.SurfaceHandoffTicketRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset>("IdentityExpiresAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("identity_expires_at_utc");
                    ...
                    b.Property<string>("SourceSurfaceKey")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)")
                        .HasColumnName("source_surface_key");
                    ...
                    b.Property<string>("TargetSurfaceKey")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)")
                        .HasColumnName("target_surface_key");
                    ...
                    b.ToTable("surface_handoff_tickets", (string)null);
                });
            ...
            modelBuilder.Entity("Callora.Core.Domain.Tenants.TenantMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Callora.Core.Domain.Workspaces.WorkspaceMembershipRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Callora.Core.Domain.Workspaces.WorkspaceMembershipRole", b =>
                {
                    b.HasOne("Callora.Core.Domain.Workspaces.WorkspaceMembership", "Membership")
                        .WithMany("Roles")
