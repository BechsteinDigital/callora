...
public sealed class CuratedPluginServiceProviderTests
{
    ...
    public void ResolvesContractsAndLogging_ButBlocksHostInternals()
    {
        ...
        services.AddSingleton<IBackgroundJobStore, Callora.Core.Application.Jobs.InMemoryBackgroundJobStore>();
    ...
    {
        var services = new ServiceCollection();
        services.AddSingleton<IPluginDataStore>(new Callora.Core.Application.Plugins.InMemoryPluginDataStore());
        using var root = services.BuildServiceProvider();
