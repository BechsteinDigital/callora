...
namespace Callora.Plugin.Communication.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260721214818_EnforceWorkspaceIntegrity")]
    partial class EnforceWorkspaceIntegrity
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("Callora.Plugin.Communication.Domain.Accounts.SipConnection", "Connection", b1 =>
                        {
                            ...
                            b1.Property<string>("PasswordSecretRef")
                                .IsRequired()
                                .HasMaxLength(500)
                                .HasColumnType("character varying(500)")
                                .HasColumnName("password_secret_ref");
