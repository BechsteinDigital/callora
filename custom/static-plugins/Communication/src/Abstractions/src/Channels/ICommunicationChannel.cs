...
public interface ICommunicationChannel
{
    ...
    /// <summary>
    /// Aktueller Gesundheitszustand des Channels, abgeleitet aus dem Verbindungsstatus
    /// seiner Accounts — read-only, damit Konsumenten Verfügbarkeit prüfen können, ohne
    /// Persistenz zu kennen.
    /// </summary>
