...
/// real typed rows in the plugin_voip schema instead of jsonb documents. The
    ...
    IPluginDataProtector dataProtector) : ISipAccountStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var row = new SipAccount
        {
            ...
            ProtectedSecret = dataProtector.Protect(VoipPlugin.Id, request.Secret),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        row.ProtectedSecret = dataProtector.Protect(VoipPlugin.Id, request.Secret);
