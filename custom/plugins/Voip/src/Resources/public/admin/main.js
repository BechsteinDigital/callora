(function registerVoipAdminUiExtensions() {
  ...
  const pluginsWidget = {
    widgetKey: "admin.plugins.voip-status",
    pluginId: "voip",
    slot: "plugins.main",
    title: "VoIP Extension",
    description: "VoIP plugin endpoints are connected in the admin extension surface.",
    contentHtml: "<p>VoIP admin extension bundle is loaded.</p>",
    order: 20,
    priority: 150
  };
