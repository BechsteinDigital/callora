...
2. Lies zusaetzlich `CODE_STRUCTURE_RULES.md` vor jeder Aufgabe.
3. Wende die Regeln strikt an.
4. Wenn eine User-Anforderung einer Regel widerspricht, fordere eine explizite Override-Entscheidung an.
...
2. Typen in eigene Dateien auslagern: Hilfstypen nicht als nested types innerhalb anderer Typen definieren.
3. Maximal 1000 Zeilen pro Datei, deutlich kleiner bevorzugt.
4. Kleine, fokussierte Klassen und Funktionen bevorzugen.
5. Klare Fehlerbehandlung, kein stilles `catch`.
6. Oeffentliche APIs mit XML-Dokumentation versehen.
